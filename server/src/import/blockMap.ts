...
export const FEISHU_BLOCK_MAP: FeishuBlockMapping[] = [
  ...
  { feishu: '20', name: 'chat_card', local: 'localEmbedBlock', support: 'full' },
  { feishu: '42', name: 'wiki sub-page list', local: 'localEmbedBlock', support: 'full' },
  { feishu: '51', name: 'wiki sub-page list', local: 'localEmbedBlock', support: 'full' },
  ...
  { feishu: 'chat_card', name: 'chat_card', local: 'localEmbedBlock', support: 'full' },
